...
const events = ref([
  ...
  {
    id: 'stargate-infrastructure-summit',
  ...
  {
    id: 'cristal-intelligence-launch',
  ...
  // Announcements
  {
    id: 'stargate-milestone-announcement',
